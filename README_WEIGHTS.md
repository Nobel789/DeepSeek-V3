# Nobelseek-V3 Weight File Documentation
...
The Nobelseek-V3 weight file consists of two main components: **Main Model Weights** and **MTP Modules**.
...
Nobelseek-V3 natively supports FP8 weight format with 128x128 block scaling.
